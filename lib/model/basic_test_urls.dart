...
class BasicTestUrls {
  ...
  static List<ItemData> testItemsRecent = [
    ...
    ItemData(
        ...
        itemCategory: ItemCategory.energy),
    ItemData(
        url:
            'https://open.spotify.com/episode/7hNGXd8kzHGvqMPRGTYLNa?si=ciC8dMxhRUqUpy4p0I3GPQ&dl_branch=1',
    ...
    ItemData(
        ...
        itemCategory: ItemCategory.mobility),
    ...
    ItemData(
        ...
        itemCategory: ItemCategory.information),
    ItemData(
